...
//     return (
//         <div className="flex justify-center items-center h-screen bg-red-200 " style={{ backgroundImage: `url(${bg})`, backgroundAttachment: 'fixed', backgroundSize: 'cover' }}>
...
//                         className="block btn btn-warning  w-full p-3 text-center rounded-sm text-black  dark:bg-violet-600 "  >Log in</button>
//                 </form>
//                 <div className="flex items-center pt-4 space-x-1">
//                     <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
//                     <p className="px-3 text-sm text-white">Login with  accounts</p>
//                     <div className="flex-1 h-px sm:w-16 dark:bg-gray-300"></div>
//                 </div>
...
//                     <NavLink to="/signUp"> <span className=" btn btn-link text-white">Sign Up</span></NavLink>
//                 </p>
//             </div>
